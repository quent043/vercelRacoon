...
import { activateCron } from '../../components/request';
import protectMail, { printContacts } from '../../scripts/iexec/protectMail';
...
function Dashboard() {
  ...
  return (
    <div className='max-w-7xl mx-auto text-gray-200 sm:px-4 lg:px-0'>
      ...
      <button onClick={() => protectMail()}>Protect Mail</button>
